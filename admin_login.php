...
<head>
  ...
  <style>
    ...
    .btn-primary, .login-container button {
      background-color: #0d47a1;
      border-color: #0d47a1;
    }
    .btn-primary:hover, .login-container button:hover {
...
<body>
  ...
  <div class="container-main">
    <div class="left-content">
      ...
      <p class="subtitle">Admin panel for managing users, tasks, and notifications. Securely access and control the academic workflow.</p>
    </div>
